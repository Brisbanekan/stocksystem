 ...
 *   2. 執行一次 initSheets()（非破壞性，不會清掉既有禮盒資料）
...
function initSheets() {
  ...
  if (shItems.getLastRow() === 0) {
    ...
    shItems.getRange(2, 1, 7, 8).setValues([
      [1, 'A', '公益月餅禮盒', '8入/盒', 2026, '中秋', '盒', 120],
      [2, 'B', '聖保羅蛋黃酥禮盒', '12入/盒', 2026, '中秋', '盒', 80],
      [3, 'C', '鬥茶王烏龍禮盒', '150g×2罐', 2026, '過年', '盒', 60],
      [4, 'B', '聖保羅肉粽禮盒', '10入/盒', 2026, '端午', '盒', 45],
      [5, 'A', '公益春節禮盒', '8入/盒', 2026, '過年', '盒', 80],
      [6, 'B', '聖保羅春節禮盒', '12入/盒', 2026, '過年', '盒', 50],
      [7, 'A', '公益鳳梨酥禮盒', '16入/盒', 2025, '過年', '盒', 0]
    ]);
